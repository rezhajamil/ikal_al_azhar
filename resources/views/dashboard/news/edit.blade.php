        ...
        <div class="flex flex-col">
            <div class="mt-4">
                ...
                <div class="px-6 py-4 mx-auto overflow-auto bg-white rounded-md shadow sm:mx-0 w-fit sm:w-1/2">
                    <form action="{{ route('admin.news.update', $news->id) }}" method="POST" class=""
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="headline" id="headline"
                                    value="{{ old('headline', $news->headline) }}" placeholder="" class="w-full rounded-md">
                                @error('headline')
                                    <span class="block mt-1 text-sm italic text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="w-full col-span-full">
                                ...
                                <textarea name="caption" id="caption" cols="30" rows="10" class="hidden">{!! old('caption', $news->caption) !!}</textarea>
