...
@section('body')
    <div class="w-full mx-4">
        <div class="flex flex-col">
            <div class="mt-4">
                <h4 class="text-xl font-bold text-gray-600 align-baseline">Data Jurusan</h4>
                ...
                <a href="{{ route('admin.major.create') }}"
                    class="inline-block px-4 py-2 my-2 font-bold text-white rounded-md bg-emerald-600 hover:bg-teal-600"><i
                        class="mr-2 fa-solid fa-plus"></i> Data Jurusan Baru</a>
                ...
                <div class="overflow-auto bg-white rounded-md shadow w-fit">
                    <table class="overflow-auto text-left border-collapse w-fit">
                        ...
                        <tbody>
                            @foreach ($majors as $key => $data)
                                <tr class="hover:bg-gray-200">
                                    <td class="p-4 font-bold text-gray-700 border-b">{{ $key + 1 }}</td>
                                    <td class="p-4 text-gray-700 border-b faculty">{{ $data->faculty->name }}</td>
